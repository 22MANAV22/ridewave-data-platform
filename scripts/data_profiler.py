# Block 4 - Data Profiler
# WHY: Inspect raw CSV files BEFORE building the ETL pipeline
#      so we know exactly what cleaning rules are needed
# HOW: Uses pandas to check nulls, duplicates, and data types
#      Reports findings using log_summary from ridewave_utils
