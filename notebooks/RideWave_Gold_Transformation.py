# Create Notebook: RideWave_Gold_Analytics
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 1 — Verify Silver Before Starting Gold
# WHY: Gold must not run if Silver is empty — fail fast, fail early.
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 2 — Gold Table 1: Revenue by City
# Business Question: Which city generates the most revenue for RideWave?
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 3 — Gold Table 2: Driver Performance
# Business Question: Which vehicle type earns most per city?
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 4 — Gold Table 3: Peak Hour Analysis
# Business Question: What time of day are most rides taken?
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 5 — Spark Task SP3: OPTIMIZE Impact
# WHY: Measures the actual file compaction effect of OPTIMIZE.
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 6 — Time Travel (SP Task)
# WHY: Delta automatically versions every write.
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 7 — Cohort Analysis (SQL Task S4b)
# WHY: Cohort analysis shows retention — are drivers who joined
#      in month 1 still active in the latest month?
# ────────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────────
# CELL 8 — Final Gold Verification
# ────────────────────────────────────────────────────────────────────────────────
...
# EXPECTED OUTPUT:
#   gold_city_revenue       : 6 rows  (6 cities)
#   gold_driver_performance : ~30 rows (6 cities x 5 types)
#   gold_peak_hours         : varies

# Commit:
  git add notebooks/RideWave_Gold_Transformation.py
  git commit -m "Block 9: Add Gold analytics with CTEs and ZORDER"
  git push

# CHECKPOINT QUESTIONS:
#   Q: Which city generates highest revenue?
#   Q: Which vehicle type has most rides?
#   A: Check your gold_city_revenue and gold_driver_performance tables.
#      Answers vary based on random data seed.

# DATA JOURNEY: Raw ride data (300 records with nulls and bad types)
# has been transformed into 3 business-ready Gold tables.
# RideWave's operations, finance, and HR teams can now answer
# their key questions instantly from trusted, clean data.